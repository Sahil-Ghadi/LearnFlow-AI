...
const studyPlan = [
  { id: 1, subject: 'Physics', topic: 'Quantum Mechanics', duration: '40 mins', priority: 'high' },
  { id: 2, subject: 'Calculus', topic: 'Integration Practice', duration: '25 mins', priority: 'medium' },
  { id: 3, subject: 'Chemistry', topic: 'Organic Reactions', duration: '30 mins', priority: 'medium' },
  { id: 4, subject: 'Mock Test', topic: 'Weekly Assessment', duration: '15 mins', priority: 'low' },
];
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlowCard className="lg:col-span-2" delay={0.2}>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-heading text-xl font-bold">Today's Study Plan</h2>
            <AgentBadge>Generated by AI Agents</AgentBadge>
          </div>
          <div className="space-y-3">
            {studyPlan.map((item, index) => (
              <motion.div
                ...
                className={`flex items-center justify-between rounded-lg border border-border border-l-4 bg-mode-surface-elevated p-4 ${priorityColors[item.priority as keyof typeof priorityColors]}`}
              >
